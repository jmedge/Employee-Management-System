package com.collabera.jump.configs;
...
public class SwaggerConfigs {
    ...
    Contact contact = new Contact("Justin Edge", "www.codelikeje.com", "Justin@codelikeje.com");
    ApiInfo apiInfo = new ApiInfo("Spring Boot REST API", 
    		"Spring Boot REST API for Employee Management System",
    		"0.0.1", "Justin@codelikeje.com", contact,
    		"license", "www.codelikeje.com/license", extensions);
